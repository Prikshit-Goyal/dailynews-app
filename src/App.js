    ...
    return (
      ...
      <BrowserRouter>
        ...
        <Routes>
         ...
         <Route path="/" element={<Navigate to="/dailynews-app" replace />} />
          <Route exact path="/dailynews-app" element={<News setProgress={setProgress} key="general" pageSize={10} country="in,gb,us,ca,is" category="top" heading2="News"/>}/>
          <Route exact path="/breaking" element={<News setProgress={setProgress} key="breaking" pageSize={10} country="in,gb,us,ca,is" category="top" heading2="Breaking"/>}/>
          <Route exact path="/business" element={<News setProgress={setProgress} key="business" pageSize={10} country="in,gb,us,ca,is" category="business" heading2="Business News"/>}/>
          <Route exact path="/entertainment" element={<News setProgress={setProgress} key="entertainment" pageSize={10} country="in,gb,us,ca,is" category="entertainment" heading2="Entertainment News"/>}/>
          <Route exact path="/world" element={<News setProgress={setProgress} key="world" pageSize={10} country="in,gb,us,ca,is" category="world" heading2="World News"/>}/>
          <Route exact path="/technology" element={<News setProgress={setProgress} key="technology" pageSize={10} country="in,gb,us,ca,is" category="technology" heading2="Technology News"/>}/>
